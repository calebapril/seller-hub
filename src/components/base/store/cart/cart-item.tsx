...
export default function CartItem({item, isCompact = false}: CartItemProps){
  ...
  return <div className={cn("flex gap-4 py-4", isCompact ? "items-start" : "items-center")}>
    <div className={cn("relative overflow-hidden rounded-md border bg-muted", isCompact ? "h-20 w-20" : "h-24 w-24")}>
